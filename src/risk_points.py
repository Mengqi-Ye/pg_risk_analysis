...
from damage_points import assess_damage_osm
...
if __name__ == "__main__":
    ...
    save_risk = risk_output(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6]) #country_code,hazard_type,infra_type,climate_model,geo_type
